...
async function loadAccounts() {
  try {
    ...
    const response = await fetch('/api/debug/accounts/list');
...
async function updatePrice() {
  ...
  try {
    const response = await fetch(`/api/debug/ticker/${state.currentSymbol}?accountId=${state.currentAccountId}`);
    const data = await response.json();
...
async function loadAccountInfo() {
  ...
  try {
    ...
    const response = await fetch(`/api/debug/account?accountId=${state.currentAccountId}`);
    const data = await response.json();
...
async function loadPositions() {
  ...
  try {
    const response = await fetch(`/api/debug/positions?accountId=${state.currentAccountId}`);
    const data = await response.json();
...
async function submitOrder() {
  ...
  const endpoint = state.orderType === 'limit' ? 
    '/api/debug/order/limit' : 
    '/api/debug/order/market';
...
async function closePosition(positionId, symbol, side) {
  ...
  try {
    ...
    const response = await fetch('/api/debug/position/close', {
      method: 'POST',
      headers: {
...
async function saveAccount() {
  ...
  try {
    const response = await fetch('/api/debug/accounts/add', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function deleteAccount(accountId) {
  ...
  try {
    const response = await fetch(`/api/debug/accounts/${accountId}`, {
      method: 'DELETE'
    });
...
async function submitTPSL(event) {
  ...
  try {
    const response = await fetch('/api/debug/position/set-tpsl', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function submitDefenseAdd(event) {
  ...
  try {
    const response = await fetch('/api/debug/position/defense-add', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        accountId: state.currentAccountId,
